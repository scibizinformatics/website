<template>
  <b-container>
    ...
    <b-row style="margin-top: 20px; background: #f2f2f2; padding: 40px 10px;">
      <b-col sm="12" md="6">
    ...
    <b-row style="margin-top: 0px; background: #f9f9f9; padding: 40px 10px;">
      <b-col sm="12" md="6">
    ...
    <b-row style="margin-top: 0px; background: #f2f2f2; padding: 40px 10px;">
      <b-col sm="12" md="6">
